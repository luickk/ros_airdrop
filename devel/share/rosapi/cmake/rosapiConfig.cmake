...
if("TRUE" STREQUAL "TRUE")
  set(rosapi_SOURCE_PREFIX /home/pi/airdrop_ros/src/rosbridge_suite/rosapi)
  set(rosapi_DEVEL_PREFIX /home/pi/airdrop_ros/devel)
  set(rosapi_INSTALL_PREFIX "")
  set(rosapi_PREFIX ${rosapi_DEVEL_PREFIX})
else()
  set(rosapi_SOURCE_PREFIX "")
  set(rosapi_DEVEL_PREFIX "")
  set(rosapi_INSTALL_PREFIX /home/pi/airdrop_ros/install)
...
if(NOT "/home/pi/airdrop_ros/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosapi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/airdrop_ros/src/rosbridge_suite/rosapi/${idir}'.  ${_report}")
    endif()
