...
if("TRUE" STREQUAL "TRUE")
  set(test_diagnostic_aggregator_SOURCE_PREFIX /home/pi/airdrop_ros/src/diagnostics/test_diagnostic_aggregator)
  set(test_diagnostic_aggregator_DEVEL_PREFIX /home/pi/airdrop_ros/devel)
  ...
  set(test_diagnostic_aggregator_INSTALL_PREFIX /home/pi/airdrop_ros/install)
...
if(NOT "/home/pi/airdrop_ros/src/diagnostics/test_diagnostic_aggregator/include " STREQUAL " ")
  set(test_diagnostic_aggregator_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/airdrop_ros/src/diagnostics/test_diagnostic_aggregator/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_diagnostic_aggregator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/airdrop_ros/src/diagnostics/test_diagnostic_aggregator/${idir}'.  ${_report}")
    endif()
